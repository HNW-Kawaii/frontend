...
import BG from '../../assets/imgs/ventura.jpg'
    ...
    <div className={style.main}>
      ...
      <div className={style.contain}>
        ...
        <div className={style.profile}>
          <img className={style.img} src={user.profile} alt="" />
          <div className={style.info}>
            <div className={style.name}><FontAwesomeIcon className={style.name_icon} icon={faAt} /> { user.name }</div>
          ...
          <>
            ...
            <div className={style.card_contain}>
              ...
              <div className={style.card}>
                ...
                <div className={style.card_text}>React 라이브러리</div>
                <div className={style.tags}>
                  <div className={style.tag}>#프로그래밍</div>
                </div>
              </div>
              <div className={style.card}>
                ...
                <div className={style.card_text}>Express.js 백엔드 강의</div>
                <div className={style.tags}>
                  <div className={style.tag}>#프로그래밍</div>
                </div>
              </div>
